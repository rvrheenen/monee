...
simulations[1]="${base_params} ${exp_params} --stealMargin 20 --stealAmount 40 --specialiserLifeCap 3000"
simulations[2]="${base_params} ${exp_params} --stealMargin 20 --stealAmount 40 --specialiserLifeCap 5000"

simulations[3]="${base_params} ${exp_params} --stealMargin 40 --stealAmount 40 --specialiserLifeCap 2000"
simulations[4]="${base_params} ${exp_params} --stealMargin 80 --stealAmount 40 --specialiserLifeCap 2000"

simulations[5]="${base_params} ${exp_params} --stealMargin 20 --stealAmount 80 --specialiserLifeCap 2000"
simulations[6]="${base_params} ${exp_params} --stealMargin 20 --stealAmount 120 --specialiserLifeCap 2000"
simulations[7]="${base_params} ${exp_params} --stealMargin 20 --stealAmount 200 --specialiserLifeCap 2000"
